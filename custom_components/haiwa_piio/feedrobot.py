...
from  custom_components.feedrobot import (
...
DEMO_VACUUM_COMPLETE = '0_feed_robot'
DEMO_VACUUM_MOST = '1_feed_robot'
DEMO_VACUUM_BASIC = '2_feed_robot'
DEMO_VACUUM_MINIMAL = '3_feed_robot'
DEMO_VACUUM_NONE = '4_feed_robot'
DEMO_VACUUM_STATE = '5_feed_robot'
